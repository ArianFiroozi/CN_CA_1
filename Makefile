...
# Project:  CN_P1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile CN_P1.pro -config release
#############################################################################
...
INCPATH       = -I. -I../Documents/libdatachannel/include -I/usr/include/qt -I/usr/include/qt/QtMultimedia -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I. -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
LIBS          = $(SUBLIBS) -L/home/arian/Documents/libdatachannel/build -ldatachannel -L/home/arian/Qt/Tools/OpenSSLv3/src/util -lcrypto -lssl /usr/lib/libQt5Multimedia.so /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Network.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: CN_P1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		CN_P1.pro
	$(QMAKE) -o Makefile CN_P1.pro -config release
